...
const Pagination: React.FC<PaginationProps> = ({ page, setPage, isClientsLoading, clientsData }) => {
    if (!clientsData?.pagination || clientsData.pagination.totalPages <= 1) return null;

    const { currentPage, totalPages, hasPrevPage, hasNextPage } = clientsData.pagination;
